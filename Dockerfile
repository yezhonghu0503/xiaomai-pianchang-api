...
# Node 16（自带 OpenSSL 1.1.1）。Node 18/20 自带 OpenSSL 3，连 Atlas 免费共享集群
# 会 TLS 握手失败报 alert 80（报错路径 deps/openssl 即 Node 内置 OpenSSL）。
# 降到 Node 16 用 OpenSSL 1.1.1 可解决；16.20.2 满足 mongodb 6.x（≥16.20.1）。
